...
def RocketSimulator(param):
	...
	if 'rocket' in param:
		if param['rocket'].lower() == 'ariane5':
			rocketparams['rocket'] = 'ariane5'
			rocketparams['stats'] = 0
		elif param['rocket'].lower() == 'falcon9':
			rocketparams['rocket'] = 'falcon9'
			rocketparams['stats'] = 0
		elif param['rocket'].lower() == 'saturnv':
			rocketparams['rocket'] = 'saturnv'
			rocketparams['stats'] = 0
		elif param['rocket'].lower() == 'soyuz2b':
			rocketparams['rocket'] = 'soyuz2b'
			rocketparams['stats'] = 0
		else:
			rocketparams['rocket'] = 'custom'
	...
	if 'pitchAlt' in param:
		rocketparams['pitchAlt'] = param['pitchAlt']
	else:
	 	rocketparams['pitchAlt'] = 10000
	if 'pitchT' in param:
		rocketparams['pitchT'] = param['pitchT']
	else:
	 	rocketparams['pitchT'] = 2.5
	if 'initAng' in param:
		rocketparams['initAng'] = param['initAng']
	else:
	 	rocketparams['initAng'] = 4
	if 'pitchAng' in param:
		rocketparams['pitchAng'] = param['pitchAng']
	else:
	 	rocketparams['pitchAng'] = 45
	if 'gmax' in param:
