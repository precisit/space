...
datapoints2y = np.array([[2.14,2.24,2.31,2.34,2.365,2.39,2.410,2.425,2.435,2.443,2.457],
						[2.1,2.2,2.265,2.3,2.325,2.35,2.37,2.38,2.39,2.405,2.415]])
...
tck = interpolate.bisplrep(datapointsx,datapointsvar,datapointsy,)
...
plt.plot(datapointsx[0,:],datapointsy[0,:],'r+')
#plt.plot(datapointsx[1,:],datapointsy[1,:],'b+')
plt.plot(datapointsx[2,:],datapointsy[2,:],'g+')
