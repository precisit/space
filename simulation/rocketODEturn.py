...
def projectileDrag(t,w):
	...
	dgdt =-norm(grav)/norm(velocities)*math.cos(gamma)
	...
	return [velocities[0], (1/Mcurr)*(-dragF*Vunit[0]+Thr*math.cos(gamma))-grav[0],
			velocities[1], (1/Mcurr)*(-dragF*Vunit[1]+Thr*math.sin(gamma))-grav[1],
